...
This directory contains source files for the Southern East Cree language
...
-   <https://giellalt.uit.no/lang/crj/SouthernEastCreeDocumentation.html>
    (analyser)
...
The Southern East Cree language sources can be acquired using [giella
